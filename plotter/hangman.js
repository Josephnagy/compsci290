...
function flashElement(id, color){
    ...
    // change color back after __ seconds 
    setTimeout(function() {
        document.getElementById(id).style.backgroundColor = currentColor;} , 500); 
}
...
function letterGuess () {
    ...
    if (secretWord.includes(guess)) {
        ...
        // flash letters remaining 
        flashElement("letters-remaining", "green"); // flashElement(id, color)
    } else {
        flashElement("letters-remaining", "red");
    }
    ...
    // flash guesses decreasing
    flashElement("guesses-remaining", "red");
